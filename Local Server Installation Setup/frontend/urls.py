...
urlpatterns = [
    ...
    path('home/syncNumberPipeDataJSON', views.syncNumberPipeDataJSON, name='syncNumberPipeDataJSON'),
    path('home/syncPipeDataJSON', views.syncPipeDataJSON, name='syncPipeDataJSON'),
    path('home/changeSyncMachineJSON', views.changeSyncMachineJSON, name='changeSyncMachineJSON'),
]